...
void pass_by_refrence_double_pointer(int **p)
{ // can also say call by refrence or pointer to pointer.
    *p = &global_var;
    /*
...
void pass_by_refrence_refrence_to_pointer(int *&p)
{ // can also say call by refrence or reference to a pointer.
    p = &global_var;
    /*
